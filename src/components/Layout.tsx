...
const NAV_ITEMS = [
  { label: 'Incidents', path: '/', icon: AlertTriangle, adminOnly: true },
  { label: 'My World', path: '/my-world', icon: Home, userOnly: true },
  { label: 'Incidents', path: '/incidents', icon: AlertTriangle, userOnly: true },
  { label: 'Operations Console', path: '/operations', icon: Crosshair },
  ...
  { label: 'On-Call', path: '/oncall', icon: Clock },
  {
    label: 'Escalation Policies', path: '/escalation-policies', icon: Shield
  },
  { label: 'Schedules', path: '/schedules', icon: Clock },
  { label: 'Analytics', path: '/analytics', icon: BarChart3 },
  { label: 'Integrations', path: '/integrations', icon: Plug },
  { label: 'Status', path: '/status', icon: Globe },
  { label: 'AIOps', path: '/aiops', icon: Bot },
  { label: 'Response Plays', path: '/response-plays', icon: Activity },
];
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7] flex flex-col">
      <header className="bg-[#25352c] text-white h-14 flex items-center px-4 z-50 flex-shrink-0">
        ...
        <Link to={onboardingRole === 'user' ? '/my-world' : '/'} className="flex items-center gap-2 mr-6">
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <button className="bg-[#06ac38] hover:bg-[#059c32] text-white text-sm px-3 py-1.5 rounded flex items-center gap-1">
          ...
          <Link to="/users/user-1" className="w-8 h-8 rounded-full bg-[#0D47A1] flex items-center justify-center text-xs font-bold ml-1">SC</Link>
        </div>
      </header>
